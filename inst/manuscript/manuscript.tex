...
(Equation\textasciitilde{}\ref{eq-marginal}):
...
efficient. Both the liklelihood-based leave-one-out cross validation
...
estimates of covariance parameters \citep{cressie1993asymptotic}. A
drawback of REML is that likelihood-based statistics are often
considered invalid when the models have different explanatory variable
or fixed effect structures \citep{wolfinger1993covariance}, though
...
R> spbeta_reduced_ml <- update(spbeta_geo, estmethod = "ml", formula = turnout ~ 1)
